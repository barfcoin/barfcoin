...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Barfcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"barfcointools.com", "dnsseed.barfcointools.com"},
    {"barfcoinpool.org", "dnsseed.barfcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"barfcointools.com", "testnet-seed.barfcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Barfcoin is probably already running."), addrBind.ToString().c_str());
        else
